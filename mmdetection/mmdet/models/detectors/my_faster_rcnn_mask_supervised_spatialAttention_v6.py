...
class FasterRCNN_RGBTwMask_wSpaAttV6(BaseDetector):
    def __init__(self,
                 share_weights,
                 backbone,
                 taf_cfg,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FasterRCNN_RGBTwMask_wSpaAttV6, self).__init__(init_cfg=init_cfg)
    ...
    def __init__(self,
        ...
        for idx, in_c in enumerate(in_channels):
            ...
            self.add_module(f'rgb_deformable_layer_{idx}',
                            build_conv_layer(dict(type='DCNv2', deform_groups=1), in_c, in_c, kernel_size=3,
                                             padding=1,
                                             bias=False))
