...
train_pipeline = [
    dict(type='Mosaic_RGBT', img_scale=img_scale, rgb_pad_val=83.82, lwir_pad_val=44.71),
    dict(
        type='RandomAffineRGBT',
        max_rotate_degree=0,
        scaling_ratio_range=(0.1, 2),
        border=(-img_scale[0] // 2, -img_scale[1] // 2), # 图像经过马赛克处理后会放大4倍，所以我们使用仿射变换来恢复图像的大小。
        rgb_border_val=(83.82, 83.82, 83.82),
        lwir_border_val=(44.71, 44.71, 44.71)),
