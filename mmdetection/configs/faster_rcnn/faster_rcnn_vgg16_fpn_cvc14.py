...
load_from = 'runs/FasterRCNN_vgg16_w_mask_SpaAttV2_ROIFocalLoss5_CIOU20_cosineSE_notDetach_negEntropy1/epoch_9.pth'
modality = 'lwir'
load_RGBT = True

data_root = '/home/zx/cross-modality-det/datasets/cvc14/coco_format'
...
lwir_mean = [137.980, 137.980, 137.980]
lwir_std = [53.335, 53.335, 53.335]

rgb_mean = [86.534, 86.534, 86.534]
rgb_std = [47.778, 47.778, 47.778]
...
model = dict(
    type='FasterRCNN_RGBTwMask_wSpaAttV2_CVC14',
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='CrossEntropyLoss', use_sigmoid=True, loss_weight=10.0), # use_sigmoid=True, rpn_cls的cls_out_channels=1
    ...
    train_cfg=dict(
        rpn=dict(
            ...
            assigner=dict(
                type='MaxIoUAssigner',
                pos_iou_thr=0.8,    # iou(gt, anchor)>0.7的anchor定义为正样本，分配大于1的标签
