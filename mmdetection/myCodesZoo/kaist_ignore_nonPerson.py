...
out_data_root = osp.join(data_root, 'zx-sanitized-kaist-keepPerson-fillNonPerson')
...
with warnings.catch_warnings():
    ...
    for mode in ['train', 'test']:
        ...
        for irf, vif, anf in tqdm(zip(lwir_imgs, vis_imgs, annos), total=len(lwir_imgs), desc=f'processing {mode}...'):
