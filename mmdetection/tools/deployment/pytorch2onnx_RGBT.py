...
from mmdet.core.export.pytorch2onnx_RGBT import build_model_from_cfg, preprocess_example_input
...
def pytorch2onnx(model,
    ...
    img_list, img_meta_list = ([one_img], [one_img]), [[one_meta]]
...
def parse_normalize_cfg(test_pipeline):
    ...
    norm_config_li = [_ for _ in transforms if _['type'] == 'NormalizeRGBT']
